...
public class IconShowcase extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Slider slider = new Slider(0.25, 6, 1);
        slider.valueProperty().addListener((observableValue, oldFontSize, fontSize) -> {
            button.setStyle("-fx-font-size: " + fontSize + "em;");
        });

        VBox vBox = new VBox(stackPane, slider);
